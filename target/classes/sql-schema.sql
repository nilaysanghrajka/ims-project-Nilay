...
create table if not exists ims.orders (id int primary key auto_increment, customer_id int NOT NULL, item_id int NOT NULL, units double, FOREIGN KEY (customer_id) REFERENCES customers(id), FOREIGN key (item_id) REFERENCES items(id));
